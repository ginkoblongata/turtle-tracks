...
public final class Machine
{
	...
	{
		Vector v = new Vector();
		Enumeration anEnumeration = _procs.keys();
	...
	{
		Vector v = new Vector();
		Enumeration anEnumeration = _proplists.keys();
		...
		CaselessString name)
	{
		...
		{
			Vector v = new Vector();
			Enumeration anEnumeration = list.keys();
		...
		CaselessString name)
	{
		...
		else
		{
			...
			while (anEnumeration.hasMoreElements())
			{
				CaselessString key = (CaselessString)(anEnumeration.nextElement());
	...
	public final void closeAllIO()
	{
		synchronized (_fileids)
		{
			Enumeration anEnumeration = _fileids.keys();
			
			try
			{
				while (anEnumeration.hasMoreElements())
				{
					closeIO((CaselessString)(anEnumeration.nextElement()));
				}
			}
		...
		LanguageException
	{
		...
		if (names != null)
		{
			anEnumeration = names.enumerateCaselessStrings();
		}
		else
		{
			anEnumeration = _syms.getEnumeratedNames();
		}
		while (anEnumeration.hasMoreElements())
		{
			CaselessString sym = (CaselessString)(anEnumeration.nextElement());
		...
		if (plists != null)
		{
			anEnumeration = plists.enumerateCaselessStrings();
		}
		else
		{
			anEnumeration = _proplists.keys();
		}
		while (anEnumeration.hasMoreElements())
		{
			CaselessString sym = (CaselessString)(anEnumeration.nextElement());
		...
		if (procs != null)
		{
			anEnumeration = procs.enumerateCaselessStrings();
		}
		else
		{
			anEnumeration = _procs.keys();
		}
		while (anEnumeration.hasMoreElements())
		{
			CaselessString sym = (CaselessString)(anEnumeration.nextElement());
